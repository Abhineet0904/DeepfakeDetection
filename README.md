...
1.
   - st_pages should be downloaded as : `pip install st-pages==0.4.1`
...
4.
   - In project settings, go to Service accounts and click on Generate new private key. Paste the downloaded firebase-adminsdk file with .json extension in your project's root directory.    - Then paste the name of this file in .env file in your root folder in the following way :
   - `FIREBASE_PRIVATE_JSON_KEY = "_______"`



5.
   - Then go to General in project settings. In SDK setup and configuration, click on Config radio button, and copy the Firebase configuration object. Paste the object in the .env file in  the following way :
...
6.
   - Now go to **https://aistudio.google.com/apikey** and create a new API key, select your project and copy the generaed key. Paste this key in your .env file like this :
...
9.
   - Also add other SMTP related information like this :
